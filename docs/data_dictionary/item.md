...
Items the game knows about. Specialized item types like Potions are variants of Item rather than separate models.

## Location

Canonical schema stub: `data_model/item.json`
