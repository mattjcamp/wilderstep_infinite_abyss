...
Future location: `web/public/modules/<module_id>/quests.json` (per-module). The Quest data models have not been formally designed yet. This doc is a placeholder.
