...
The canonical definition of an adventure. Contains all the custom schema that define the game world using the other data models. Think of a Module as a template — static content authored once and shipped.
